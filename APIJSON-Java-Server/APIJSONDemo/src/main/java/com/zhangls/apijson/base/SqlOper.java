...
public class SqlOper {
    ...
    public static String isNull() {
        return isNull(Boolean.TRUE);
    }

    /**
     * true : sql append "is null "
     * false : sql append "is  NOT  null "
     */
    ...
    /**
     *  true : sql append  s + "is null"
     *  false: sql append  s + "is not null" 
     */
    public static String isNull(String str, boolean isNull) {
        return str + isNull(isNull);
    }
     ...
     *
     * s= "str"
     * result is  "str is  null  OR length(str)<=0"
     */
